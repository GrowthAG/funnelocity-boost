          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-[#d0ff00] text-black">
                <th className="py-4 px-6 text-left font-bold text-lg">Ferramentas</th>
                <th className="py-4 px-6 text-center font-bold text-lg">Substitui</th>
                <th className="py-4 px-6 text-right font-bold text-lg">Valor</th>
            ...
            <tbody className="text-base">
              {replacementTools.map((tool, index) => (
                ...
                >
                  <td className="py-4 px-6 text-left font-medium">{tool.name}</td>
                  ...
                  <td className="py-4 px-6 text-right font-medium text-lg">{tool.value}</td>
              ...
              <tr className="border-t-2 border-[#d0ff00] bg-black/80">
                ...
                <td className="py-5 px-6 text-right font-bold text-2xl text-[#d0ff00]">{totalSaving}</td>
          ...
          <div className="p-6 bg-black/30 border border-white/10 rounded-xl">
            ...
            <div className="mt-4 text-center">
              ...
              <div className="flex items-center justify-center">
                <span className="text-4xl font-bold text-[#d0ff00]">R$ {billingAnnual ? '4.970' : '497'}</span>
