  ...
  return (
    <div className="min-h-screen bg-black py-20">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="mb-24 overflow-hidden rounded-xl bg-white/5 border border-[#d0ff00]/20 shadow-lg">
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="bg-white/5 rounded-lg p-6 space-y-6 flex-1 shadow-inner">
                ...
                <div className="h-40 bg-black/30 rounded-lg flex items-center justify-center">
                  <BarChart2 className="h-12 w-12 text-[#d0ff00]/50" />
                </div>
              </div>
            </div>
            <div className="flex flex-col h-full">
              ...
              <div className="bg-white/5 rounded-lg p-6 flex-1 flex items-center justify-center shadow-inner">
                <div className="text-center">
                  <Workflow className="h-20 w-20 text-[#d0ff00]/50 mx-auto mb-8" />
                  <p className="text-white text-lg mb-6">Crie sua automação</p>
                  <div className="mt-4 py-2 px-6 bg-[#d0ff00] rounded-full text-black inline-block text-base font-medium">
                    Começar Agora
                  </div>
                </div>
              </div>
        ...
        <div className="text-center mt-24 py-16">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            <Link to="/pricing">
              <Button className="bg-[#d0ff00] hover:bg-[#b3e600] text-black px-8 py-6 text-lg" size="lg">
                Ver Planos e Preços
              </Button>
            </Link>
            <Link to="/demo">
              <Button className="border border-[#d0ff00]/30 text-[#d0ff00] hover:bg-[#d0ff00]/10 px-8 py-6 text-lg" size="lg" variant="outline">
                Agendar Demo
              </Button>
            </Link>
          </div>
