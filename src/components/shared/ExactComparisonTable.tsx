...
const ExactComparisonTable: React.FC<ExactComparisonTableProps> = ({
  ...
  return <div className={`bg-black text-white ${className}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 border-t border-white/20">
        ...
        {/* Right column */}
        <div>
          <div className="p-4 border-b border-white/20 flex allign center items-start">
            <h3 className="text-xl font-bold text-white text-justify">Com GrowthFunnels você paga:</h3>
          ...
          <div className="space-y-4 p-4 py-[15px]">
            <div className="flex items-start gap-2 py-[5px] bg-neutral-900 rounded-md mx-0 px-[10px]">
            ...
            <div className="flex items-start gap-2 py-[5px] bg-neutral-900 rounded-md px-[10px]">
            ...
            <div className="flex items-start gap-2 py-[6px] bg-neutral-900 rounded-md px-[10px]">
